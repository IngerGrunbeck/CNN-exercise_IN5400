...
# todo
# legg inn alle kategorier som mulige komboer, hent gjerne fra liste. Denne listen kan også brukes til å kalle filene.
# desse to tingene må forresten kombineres.

# implementer antall viste bilder og kategorier som gitt i oppgåveteksten
...
def main():
    class_file = 'aeroplane_filenames.npy'
    path = os.path.join(ROOT_FOLDER, class_file)
    files = np.load(path).tolist()
